  ...
  return (
    <div className="bg-[#1E1E1E] text-white p-4 rounded-lg shadow-xl ">
      ...
      <div className="mt-2 md:mt-4 bg-white p-3 md:p-4  rounded-lg opacity-20 w-full text-black text-xs md:text-sm">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet expedita necessitatibus
        voluptate quis provident sunt molestias tempore voluptas voluptates explicabo!
      </div>
    </div>
  );
});
